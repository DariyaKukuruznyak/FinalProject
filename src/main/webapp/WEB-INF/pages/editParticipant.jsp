    ...
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <form class="form-horizontal" action="?command=updateParticipant&participantId=${participant.id}" method="POST">
                                    ...
                                    <tr>
                                        <td>
                                            <div>${tournament.fullName} <a class="btn btn-info"
                                                                           href="?command=excludeTournament&tournamentId=${tournament.id}"><span
                    ...
                    <table class="table">
                        ...
                        <c:forEach items="${activeTournaments}" var="tournament">
                            <tr>
                                <td>
                                    <div>${tournament.fullName} <a class="btn btn-info"
                                                                   href="?command=includeTournament&tournamentId=${tournament.id}"><span
