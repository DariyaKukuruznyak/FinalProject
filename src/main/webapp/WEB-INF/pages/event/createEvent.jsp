...
<div class="container">
    ...
    <div class="panel-body">
        ...
        <c:if test="${not empty selectedTournament}">
                <a href="?command=createEvent" class="btn btn-success"><h2><fmt:message key="create_event" bundle="${bundle}"/></h2></a>
        </c:if>
        <div class="row">
            <div class="col-sm-6">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="?command=selectTournament&tournamentId=${tournament.id}"><span
                                            class="glyphicon glyphicon-ok"></span> <fmt:message key="select" bundle="${bundle}"/></a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
            ...
            <div class="col-sm-6">
                <c:if test="${not empty selectedTournament}">
                    ...
                    <div class="form-group row">
                        <label for="country" class="col-sm-4 col-form-label"><fmt:message key="country" bundle="${bundle}"/></label>
                        <div class="col-sm-8">
                            <div id="country">${selectedTournament.country}</div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="beginningDateAndTime" class="col-sm-4 col-form-label"><fmt:message key="date_of_beginning" bundle="${bundle}"/></label>
                        <div class="col-sm-8">
                            <div id="beginningDateAndTime">${selectedTournament.beginningDateAndTime}</div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="participantsNumber" class="col-sm-4 col-form-label"><fmt:message key="number_of_participant" bundle="${bundle}"/></label>
                        <div class="col-sm-8">
